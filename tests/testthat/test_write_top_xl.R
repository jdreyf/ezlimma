...
test_that("returned df", {
  ...
  wtx1 <- ezlimma:::write_top_xl(pwy.tab=rcn.f, feat.lst=fl, feat.tab=eztt, n.toptabs = 1)
...
test_that("write out file", {
  ...
  ezlimma:::write_top_xl(pwy.tab=rcn.f, feat.lst=fl, feat.tab=eztt, name="text_wtx", n.toptabs = 1)
