...
test_that('filters out the right gene sets', {
  expect_equal(g_index(G = G2,object = M,min.ngenes = 3,max.ngenes = 10),out.2)
  expect_error(g_index(G = G2,object = M,min.ngenes = 50,max.ngenes = 100),"No gene sets are of the right size.")
})